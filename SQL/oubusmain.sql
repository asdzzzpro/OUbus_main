...
CREATE TABLE `admin` (
  ...
  `tenAdmin` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `chuyenxe` (
  `maChuyenXe` varchar(10) NOT NULL,
  `maXe` int NOT NULL,
...
INSERT INTO `chuyenxe` VALUES ('1',1,'2019-03-04',20000,'BinhDinh','TPHCM');
...
CREATE TABLE `vexe` (
  ...
  KEY `maGhe` (`maGhe`),
  KEY `maNV` (`maNV`),
  CONSTRAINT `vexe_ibfk_1` FOREIGN KEY (`maChuyenXe`) REFERENCES `chuyenxe` (`maChuyenXe`),
...
-- Dump completed on 2022-04-26  6:26:27
